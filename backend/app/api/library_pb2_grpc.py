...
class LibraryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateBook = channel.unary_unary(
                ...
                response_deserializer=library__pb2.BookId.FromString,
        ...
        self.CreateMember = channel.unary_unary(
                ...
                response_deserializer=library__pb2.MemberId.FromString,
                _registered_method=True)
        ...
        self.GetMemberBorrowings = channel.unary_unary(
                '/library.LibraryService/GetMemberBorrowings',
                request_serializer=library__pb2.MemberId.SerializeToString,
                response_deserializer=library__pb2.BorrowingList.FromString,
                _registered_method=True)
...
def add_LibraryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateBook': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=library__pb2.BookId.SerializeToString,
            ),
            ...
            'CreateMember': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=library__pb2.MemberId.SerializeToString,
            ),
            ...
            'GetMemberBorrowings': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=library__pb2.MemberId.FromString,
                    response_serializer=library__pb2.BorrowingList.SerializeToString,
            ),
    }
...
class LibraryService(object):
    ...
    def CreateBook(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            library__pb2.BookId.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def CreateMember(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            library__pb2.MemberId.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetMemberBorrowings(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/library.LibraryService/GetMemberBorrowings',
            library__pb2.MemberId.SerializeToString,
            library__pb2.BorrowingList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
